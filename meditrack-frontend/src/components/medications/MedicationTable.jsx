        ...
        <tbody className="bg-white divide-y divide-gray-100">
          {medications.map(med => (
            <tr key={med.id} className="hover:bg-gray-50">
              ...
              <td className="px-4 py-3 text-gray-600">{FREQ_LABELS[med.frequency] ?? med.frequency}</td>
              <td className="px-4 py-3 text-gray-600">{med.startDate}</td>
              <td className="px-4 py-3 text-gray-400">{med.endDate ?? '—'}</td>
